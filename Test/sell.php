...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-5" style="padding-left: 50px;" >
      <h2 style="padding-top: 10px"><b>Product Name</b></h2>
      <h4>NGO - Drishti</h4>
      <p style="padding-top: 10px;padding-right: 20px;"><b>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt</b></p>         
        <div id="btn">
          <br>
          <button id= "btn1" onclick="">Add to Cart</button>
          <button id= "btn1" onclick="">Add to WishList</button>
          <br><br>
          <h2>Price: Rs 1,00,000</h2>
