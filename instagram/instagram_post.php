...
class instagram_post {
    ...
    const USERNAME = "tanmayrauth"; // TODO; Enter your Instagram username here to authenticate
    const PASSWORD = "T24091996"; // TODO; Enter your Instagram password here to authenticate
    ...
    public function doPostImage($filename, $caption) {
        $filename = $_SERVER['DOCUMENT_ROOT'] .\trim(str_replace($_SERVER['DOCUMENT_ROOT'], '', $filename), DIRECTORY_SEPARATOR);
        echo $filename;
